...
namespace FTI.Trialmax.Forms
{
	...
	public class CFImportXmlCaseCodes : CFTmaxBaseForm
	{
		#region Constants
		...
		private void InitializeComponent()
		{
			...
			this.m_ctrlWarningLine2.Text = "All users are affected by this change.";
			...
			this.m_ctrlWarningLine1.Text = "This operation will replace all existing data fields and pick lists !";
			this.m_ctrlWarningLine1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// CFImportXmlCaseCodes
			// 
			...
			this.Name = "CFImportXmlCaseCodes";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Import Data Fields";
