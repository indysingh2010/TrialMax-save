...
namespace FTI.Shared.Win32
{
	...
	public abstract class Shell
	{
		...
		public static extern int SHSimpleIDListFromPath(string szPath);

		[DllImport("SHFolder", CharSet = CharSet.Auto)]
		public static extern int SHGetFolderPath(int hwndOwner, int nFolder, int
		...
		[DllImport("shlwapi", EntryPoint="PathCompactPathEx")] public static extern bool PathCompactPathEx(StringBuilder pszOut, string pszSrc, int cchMax, int dwFlags);
		[DllImport("shlwapi", EntryPoint="PathCompactPath")] public static extern bool PathCompactPath(System.IntPtr hdc, StringBuilder lpszPath, int pixels);
