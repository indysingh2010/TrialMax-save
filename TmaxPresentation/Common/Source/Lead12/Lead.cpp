...
void CLead::SetTwainMaxPages(long propVal)
{
...
{
	float result;
	GetProperty(0xc2, VT_R4, (void*)&result);
	return result;
}

void CLead::SetShapeLeft(float propVal)
{
	SetProperty(0xc2, VT_R4, propVal);
}

float CLead::GetShapeTop()
{
	float result;
	GetProperty(0xc1, VT_R4, (void*)&result);
	return result;
}

void CLead::SetShapeTop(float propVal)
{
	SetProperty(0xc1, VT_R4, propVal);
}
...
{
	float result;
	GetProperty(0xc8, VT_R4, (void*)&result);
	return result;
}

void CLead::SetShapeInnerBandThickness(float propVal)
{
	SetProperty(0xc8, VT_R4, propVal);
}
...
{
	float result;
	GetProperty(0xdb, VT_R4, (void*)&result);
	return result;
}

void CLead::SetShapeOuterBandThickness(float propVal)
{
	SetProperty(0xdb, VT_R4, propVal);
}
...
{
	float result;
	GetProperty(0xd4, VT_R4, (void*)&result);
	return result;
}

void CLead::SetTextLeft(float propVal)
{
	SetProperty(0xd4, VT_R4, propVal);
}

float CLead::GetTextTop()
{
	float result;
	GetProperty(0xd5, VT_R4, (void*)&result);
	return result;
}

void CLead::SetTextTop(float propVal)
{
	SetProperty(0xd5, VT_R4, propVal);
}
...
{
	short result;
	GetProperty(0xd8, VT_I2, (void*)&result);
	return result;
}

void CLead::SetTextAngle(short propVal)
{
	SetProperty(0xd8, VT_I2, propVal);
}
...
{
	float result;
	GetProperty(0xdf, VT_R4, (void*)&result);
	return result;
}

void CLead::SetFrameThickness(float propVal)
{
	SetProperty(0xdf, VT_R4, propVal);
}
...
{
	float result;
	GetProperty(0xe2, VT_R4, (void*)&result);
	return result;
}

void CLead::SetFrameInnerThickness(float propVal)
{
	SetProperty(0xe2, VT_R4, propVal);
}
...
{
	short result;
	GetProperty(0xe9, VT_I2, (void*)&result);
	return result;
}

void CLead::SetTextAlign(short propVal)
{
	SetProperty(0xe9, VT_I2, propVal);
}
...
{
	BOOL result;
	GetProperty(0xed, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetTransparent(BOOL propVal)
{
	SetProperty(0xed, VT_BOOL, propVal);
}
...
{
	short result;
	GetProperty(0xef, VT_I2, (void*)&result);
	return result;
}

void CLead::SetLevelHighBit(short propVal)
{
	SetProperty(0xef, VT_I2, propVal);
}
...
{
	short result;
	GetProperty(0xf3, VT_I2, (void*)&result);
	return result;
}

void CLead::SetMinBit(short propVal)
{
	SetProperty(0xf3, VT_I2, propVal);
}

short CLead::GetMaxBit()
{
	short result;
	GetProperty(0xf4, VT_I2, (void*)&result);
	return result;
}

void CLead::SetMaxBit(short propVal)
{
	SetProperty(0xf4, VT_I2, propVal);
}
...
{
	short result;
	GetProperty(0xf8, VT_I2, (void*)&result);
	return result;
}

void CLead::SetTwainIntensity(short propVal)
{
	SetProperty(0xf8, VT_I2, propVal);
}
...
{
	float result;
	GetProperty(0xfd, VT_R4, (void*)&result);
	return result;
}

void CLead::SetPanWinY(float propVal)
{
	SetProperty(0xfd, VT_R4, propVal);
}
...
{
	LPDISPATCH pDispatch;
	GetProperty(0x106, VT_DISPATCH, (void*)&pDispatch);
	return CPicture(pDispatch);
}
...
{
	BOOL result;
	GetProperty(0x110, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetRefBitmap(BOOL propVal)
{
	SetProperty(0x110, VT_BOOL, propVal);
}
...
{
	BOOL result;
	GetProperty(0x119, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetSavePageNumberTag(BOOL propVal)
{
	SetProperty(0x119, VT_BOOL, propVal);
}

short CLead::GetTwainDuplex()
{
	short result;
	GetProperty(0x11a, VT_I2, (void*)&result);
	return result;
}

void CLead::SetTwainDuplex(short propVal)
{
	SetProperty(0x11a, VT_I2, propVal);
}

short CLead::GetEnableTwainDuplex()
{
	short result;
	GetProperty(0x11b, VT_I2, (void*)&result);
	return result;
}

void CLead::SetEnableTwainDuplex(short propVal)
{
	SetProperty(0x11b, VT_I2, propVal);
}

BOOL CLead::GetLoadCompressed()
{
	BOOL result;
	GetProperty(0x11c, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetLoadCompressed(BOOL propVal)
{
	SetProperty(0x11c, VT_BOOL, propVal);
}
...
{
	short result;
	GetProperty(0x122, VT_I2, (void*)&result);
	return result;
}

void CLead::SetPreferredLoadFormat(short propVal)
{
	SetProperty(0x122, VT_I2, propVal);
}
...
{
	unsigned long result;
	GetProperty(0x126, VT_I4, (void*)&result);
	return result;
}

void CLead::SetRgnFrameColor(unsigned long propVal)
{
	SetProperty(0x126, VT_I4, propVal);
}

long CLead::GetInfoIFD()
{
	long result;
	GetProperty(0x127, VT_I4, (void*)&result);
	return result;
}

void CLead::SetInfoIFD(long propVal)
{
	SetProperty(0x127, VT_I4, propVal);
}

long CLead::GetLoadIFD()
{
	long result;
	GetProperty(0x128, VT_I4, (void*)&result);
	return result;
}

void CLead::SetLoadIFD(long propVal)
{
	SetProperty(0x128, VT_I4, propVal);
}

long CLead::GetSaveIFD()
{
	long result;
	GetProperty(0x129, VT_I4, (void*)&result);
	return result;
}

void CLead::SetSaveIFD(long propVal)
{
	SetProperty(0x129, VT_I4, propVal);
}

BOOL CLead::GetAnnUndoEnable()
{
	BOOL result;
	GetProperty(0x217, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetAnnUndoEnable(BOOL propVal)
{
	SetProperty(0x217, VT_BOOL, propVal);
}

short CLead::GetAnnUndoDepth()
{
	short result;
	GetProperty(0x218, VT_I2, (void*)&result);
	return result;
}

void CLead::SetAnnUndoDepth(short propVal)
{
	SetProperty(0x218, VT_I2, propVal);
}

short CLead::GetAnnAutoDialogFontSize()
{
	short result;
	GetProperty(0x21a, VT_I2, (void*)&result);
	return result;
}

void CLead::SetAnnAutoDialogFontSize(short propVal)
{
	SetProperty(0x21a, VT_I2, propVal);
}

short CLead::GetMagGlassFlags()
{
	short result;
	GetProperty(0x21c, VT_I2, (void*)&result);
	return result;
}

void CLead::SetMagGlassFlags(short propVal)
{
	SetProperty(0x21c, VT_I2, propVal);
}

BOOL CLead::GetEnableMagGlassEvent()
{
	BOOL result;
	GetProperty(0x21d, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetEnableMagGlassEvent(BOOL propVal)
{
	SetProperty(0x21d, VT_BOOL, propVal);
}

short CLead::GetInfoViewPerspective()
{
	short result;
	GetProperty(0x220, VT_I2, (void*)&result);
	return result;
}

void CLead::SetInfoViewPerspective(short propVal)
{
	SetProperty(0x220, VT_I2, propVal);
}

BOOL CLead::GetEnableTwainFileEvent()
{
	BOOL result;
	GetProperty(0x221, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetEnableTwainFileEvent(BOOL propVal)
{
	SetProperty(0x221, VT_BOOL, propVal);
}

BOOL CLead::GetEnableTwainFileFormatEvent()
{
	BOOL result;
	GetProperty(0x222, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetEnableTwainFileFormatEvent(BOOL propVal)
{
	SetProperty(0x222, VT_BOOL, propVal);
}

long CLead::GetTwainFileFormatStatus()
{
	long result;
	GetProperty(0x223, VT_I4, (void*)&result);
	return result;
}

void CLead::SetTwainFileFormatStatus(long propVal)
{
	SetProperty(0x223, VT_I4, propVal);
}

BOOL CLead::GetAnnAutoResize()
{
	BOOL result;
	GetProperty(0x225, VT_BOOL, (void*)&result);
	return result;
}

void CLead::SetAnnAutoResize(BOOL propVal)
{
	SetProperty(0x225, VT_BOOL, propVal);
}

float CLead::GetConvertX()
{
	float result;
	GetProperty(0x228, VT_R4, (void*)&result);
	return result;
}

void CLead::SetConvertX(float propVal)
{
	SetProperty(0x228, VT_R4, propVal);
}

float CLead::GetConvertY()
{
	float result;
	GetProperty(0x229, VT_R4, (void*)&result);
	return result;
}

void CLead::SetConvertY(float propVal)
{
	SetProperty(0x229, VT_R4, propVal);
}

long CLead::GetPDFXResolution()
{
	long result;
	GetProperty(0x22b, VT_I4, (void*)&result);
	return result;
}

void CLead::SetPDFXResolution(long propVal)
{
	SetProperty(0x22b, VT_I4, propVal);
}

long CLead::GetPDFYResolution()
{
	long result;
	GetProperty(0x22c, VT_I4, (void*)&result);
	return result;
}

void CLead::SetPDFYResolution(long propVal)
{
	SetProperty(0x22c, VT_I4, propVal);
}

long CLead::GetPDFDisplayDepth()
{
	long result;
	GetProperty(0x22d, VT_I4, (void*)&result);
	return result;
}

void CLead::SetPDFDisplayDepth(long propVal)
{
	SetProperty(0x22d, VT_I4, propVal);
}
...
short CLead::Average(short iDim)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x12a, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iDim);
	return result;
}
...
short CLead::Median(short iDim)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x12b, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iDim);
	return result;
}
...
{
	short result;
	InvokeHelper(0x12d, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x12e, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x130, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
short CLead::Hue(short iAngle)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x131, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iAngle);
	return result;
}
...
{
	short result;
	InvokeHelper(0x133, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x138, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x139, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
short CLead::Mosaic(short iDim)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x13a, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iDim);
	return result;
}
...
{
	LPDISPATCH pDispatch;
	InvokeHelper(0x13f, DISPATCH_METHOD, VT_DISPATCH, (void*)&pDispatch, NULL);
	return CPicture(pDispatch);
}
...
{
	short result;
	InvokeHelper(0x146, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x147, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x14d, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
short CLead::Halftone(short iType, long iAngle)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I4;
	InvokeHelper(0x14e, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iType, iAngle);
	return result;
}
...
short CLead::Size(float fWidth, float fHeight, short iFlags)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4 VTS_I2;
	InvokeHelper(0x14f, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::Copy(short iFlags)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x150, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iFlags);
	return result;
}
...
short CLead::Paste(short iFlags)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x151, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iFlags);
	return result;
}
...
short CLead::Load(LPCTSTR pszName, short iBitsPerPixel, long lPage, long lPages)
{
	...
	InvokeHelper(0x152, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::SetDIB(long hDIB)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x153, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hDIB);
	return result;
}
...
short CLead::SetDDB(long hDC, long hBitmap, long hPalette)
{
	...
	InvokeHelper(0x155, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::RemapIntensity(short iChannel)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x157, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iChannel);
	return result;
}
...
short CLead::GetHistogram(short iChannel)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x158, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iChannel);
	return result;
}
...
short CLead::ColorRes(short iBitsPerPixel, short iPalette, short iDither, short iColors)
{
	...
	InvokeHelper(0x159, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::Capture(long hDC, float fLeft, float fTop, float fWidth, float fHeight)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_R4 VTS_R4 VTS_R4 VTS_R4;
	InvokeHelper(0x15a, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hDC, fLeft, fTop, fWidth, fHeight);
	return result;
}
...
short CLead::ColorMerge(long iFlags)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x15c, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iFlags);
	return result;
}
...
short CLead::Underlay(long hBitmap, short iFlags)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0x15d, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hBitmap, iFlags);
	return result;
}
...
short CLead::SetDstClipRect(float fLeft, float fTop, float fWidth, float fHeight)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4 VTS_R4 VTS_R4;
	InvokeHelper(0x160, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		fLeft, fTop, fWidth, fHeight);
	return result;
}
...
short CLead::Trim(float fLeft, float fTop, float fWidth, float fHeight)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4 VTS_R4 VTS_R4;
	InvokeHelper(0x163, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		fLeft, fTop, fWidth, fHeight);
	return result;
}
...
{
	short result;
	InvokeHelper(0x16a, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
void CLead::dbEdit()
{
	InvokeHelper(0x16d, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}
...
{
	InvokeHelper(0x16f, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CLead::dbMoveLast()
{
	InvokeHelper(0x170, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CLead::dbMoveNext()
{
	InvokeHelper(0x171, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}

void CLead::dbMovePrev()
{
	InvokeHelper(0x172, DISPATCH_METHOD, VT_EMPTY, NULL, NULL);
}
...
{
	BOOL result;
	InvokeHelper(0x175, DISPATCH_METHOD, VT_BOOL, (void*)&result, NULL);
	return result;
}
...
BOOL CLead::dbOpen(LPCTSTR pszConnect, LPCTSTR pszSQL, LPCTSTR pszField, long iOptions)
{
	...
	InvokeHelper(0x176, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
...
void CLead::PrintEnd(long hDC)
{
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x179, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 hDC);
}
...
short CLead::TwainRealize(long hWnd)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x17a, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hWnd);
	return result;
}
...
void CLead::UnlockSupport(short iType, LPCTSTR pszKey)
{
	static BYTE parms[] =
		VTS_I2 VTS_BSTR;
	InvokeHelper(0x17c, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 iType, pszKey);
}
...
short CLead::GetMemoryInfo(long hMem, long lPage, long iSize)
{
	short result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4;
...
BOOL CLead::DeleteRgnHandle(long hRgn)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x184, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		hRgn);
	return result;
}
...
{
	short result;
	InvokeHelper(0x185, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	long result;
	InvokeHelper(0x186, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
	return result;
}
...
BOOL CLead::IsPtInRgn(float fx, float fy)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4;
	InvokeHelper(0x188, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		fx, fy);
	return result;
}
...
BOOL CLead::IsPtInFloater(float fx, float fy)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4;
	InvokeHelper(0x18f, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		fx, fy);
	return result;
}
...
{
	short result;
	InvokeHelper(0x19b, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
short CLead::AnnFlip(BOOL bUseHorz, float fHorz, BOOL bSelected)
{
	...
	InvokeHelper(0x19d, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
CString CLead::AnnGetAutoText(short iItem)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x1a1, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
		iItem);
	return result;
}
...
short CLead::ColorResList(short iBitsPerPixel, short iPalette, short iDither, short iColors)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I2 VTS_I2 VTS_I2;
	InvokeHelper(0x1a2, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iBitsPerPixel, iPalette, iDither, iColors);
	return result;
}
...
float CLead::DrawTextWidth(LPCTSTR pszText)
{
	...
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x1b1, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		pszText);
	return result;
}
...
float CLead::DrawTextHeight(LPCTSTR pszText)
{
	...
	static BYTE parms[] =
		VTS_BSTR;
	InvokeHelper(0x1b2, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		pszText);
	return result;
}
...
long CLead::AnnGetPointCount(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1ba, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		hObject);
	return result;
}
...
VARIANT CLead::AnnGetPointX(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1bb, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		hObject);
	return result;
}
...
VARIANT CLead::AnnGetPointY(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1bc, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		hObject);
	return result;
}
...
{
	short result;
	InvokeHelper(0x1bd, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	VARIANT result;
	InvokeHelper(0x1be, DISPATCH_METHOD, VT_VARIANT, (void*)&result, NULL);
	return result;
}
...
short CLead::FastRotate(short iAngle)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x1bf, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		iAngle);
	return result;
}
...
short CLead::AnnMove(float dxOffset, float dyOffset, BOOL bSelected)
{
	...
	InvokeHelper(0x1c0, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::DrawShape(short uShape, long BackgroundImage)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I4;
	InvokeHelper(0x1c1, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::DrawText(LPCTSTR szText, long ForegroundImage)
{
	...
	static BYTE parms[] =
		VTS_BSTR VTS_I4;
	InvokeHelper(0x1c2, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
{
	short result;
	InvokeHelper(0x1c3, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x1c4, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
{
	short result;
	InvokeHelper(0x1c5, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
short CLead::AnnLock(long hObject, LPCTSTR pszKey, BOOL fSelected)
{
	...
	InvokeHelper(0x1c6, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::AnnUnlock(long hObject, LPCTSTR pszKey)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_BSTR;
	InvokeHelper(0x1c7, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hObject, pszKey);
	return result;
}
...
short CLead::AnnUnrealize(long hObject, BOOL fSelected)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_BOOL;
	InvokeHelper(0x1c9, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hObject, fSelected);
	return result;
}
...
short CLead::AnnSaveTag(BOOL fWangMode, BOOL fSelected)
{
	...
	static BYTE parms[] =
		VTS_BOOL VTS_BOOL;
	InvokeHelper(0x1ca, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		fWangMode, fSelected);
	return result;
}
...
short CLead::AnnSetHyperlinkString(long hObject, short uType, LPCTSTR pszHyperlink)
{
	...
	InvokeHelper(0x1cb, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::AnnGetHyperlinkType(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1cd, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hObject);
	return result;
}
...
CString CLead::AnnGetHyperlinkString(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1ce, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms,
		hObject);
	return result;
}
...
long CLead::AnnGetHyperlinkParam(long hObject, short iParamIndex)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0x1cf, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		hObject, iParamIndex);
	return result;
}
...
short CLead::PreLoadFilters(short iFixedFilters, short iCachedFilters, LPCTSTR pszFilters)
{
	...
	InvokeHelper(0x1d0, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::AnnEnumerate(long hObject, short iFlags, LPCTSTR pszUserList)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2 VTS_BSTR;
	InvokeHelper(0x1d7, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::ContourFilter(short nThreshold, short nDeltaDirection, short nMaximumError, short nOption)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I2 VTS_I2 VTS_I2;
	InvokeHelper(0x1d8, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		nThreshold, nDeltaDirection, nMaximumError, nOption);
	return result;
}

short CLead::WindowLevelFillLUT(unsigned long crStart, unsigned long crEnd, long nLow, long nHigh, short nLowBit, short nHighBit, long nMinValue, long nMaxValue, BOOL bInside)
{
	short result;
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I2 VTS_I2 VTS_I4 VTS_I4 VTS_BOOL;
	InvokeHelper(0x1d9, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		crStart, crEnd, nLow, nHigh, nLowBit, nHighBit, nMinValue, nMaxValue, bInside);
	return result;
}
...
short CLead::AnnDestroy(long hObject, short iFlags)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I2;
	InvokeHelper(0x1da, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hObject, iFlags);
	return result;
}
...
long CLead::AnnCreate(short iType, BOOL bAutoInsert, BOOL bVisible)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_BOOL VTS_BOOL;
	InvokeHelper(0x1db, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
...
short CLead::AnnSetSelected(long hObject, BOOL bValue, BOOL bSelected)
{
	...
	InvokeHelper(0x1e3, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
long CLead::AnnGetObjectFromTag(long hObject, long lTag, BOOL bSelected)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_I4 VTS_BOOL;
	InvokeHelper(0x1e6, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
...
short CLead::LoadArray(const VARIANT& vMem, short iBitsPerPixel, long lPage, long lPages, long lSize)
{
	...
	InvokeHelper(0x1e9, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
VARIANT CLead::SaveArray(short iFormat, short iBitsPerPixel, short iQuality)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I2 VTS_I2;
	InvokeHelper(0x1ea, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		iFormat, iBitsPerPixel, iQuality);
	return result;
}

short CLead::AnnLoadArray(const VARIANT& vMem, long lSize)
{
	short result;
	static BYTE parms[] =
		VTS_VARIANT VTS_I4;
...
VARIANT CLead::AnnSaveArray(short iFormat, BOOL bSelected)
{
	VARIANT result;
	static BYTE parms[] =
		VTS_I2 VTS_BOOL;
	InvokeHelper(0x1ec, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		iFormat, bSelected);
	return result;
}
...
short CLead::WriteComment(LPCTSTR pszFile, long lPage)
{
	...
	static BYTE parms[] =
		VTS_BSTR VTS_I4;
	InvokeHelper(0x1ee, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		pszFile, lPage);
	return result;
}
...
long CLead::GetTagCount(long lTag)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x1f1, DISPATCH_METHOD, VT_I4, (void*)&result, parms,
		lTag);
	return result;
}
...
{
	short result;
	InvokeHelper(0x1f6, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
unsigned long CLead::GetBitmapPalette(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x1fe, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
short CLead::GetRemapTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x1ff, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		iIndex);
	return result;
}
...
long CLead::GetHistogramTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x200, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
unsigned long CLead::GetUserPalette(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x201, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
long CLead::GetColorPlanes(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x202, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
BOOL CLead::GetInfoPCDRes(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x203, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, parms,
		iIndex);
	return result;
}
...
CString CLead::GetTwainSourceList(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x204, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetPolygonX(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x205, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetPolygonY(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x206, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
unsigned long CLead::GetAnimationPalette(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x207, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetLoadResolutionWidth(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x208, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetLoadResolutionHeight(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x209, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
VARIANT CLead::GetComment(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x20a, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, parms,
		iIndex);
	return result;
}
...
unsigned long CLead::GetPixel(float x, float y)
{
	...
	static BYTE parms[] =
		VTS_R4 VTS_R4;
	InvokeHelper(0x20b, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		x, y);
	return result;
}
...
unsigned long CLead::GetLevelLUT(long iIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x20c, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetSaveResolutionWidth(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x20d, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetSaveResolutionHeight(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x20e, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		iIndex);
	return result;
}
...
float CLead::GetAnnRectLeft(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x20f, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		hObject);
	return result;
}
...
float CLead::GetAnnRectTop(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x210, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		hObject);
	return result;
}
...
float CLead::GetAnnRectWidth(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x211, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		hObject);
	return result;
}
...
float CLead::GetAnnRectHeight(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x212, DISPATCH_PROPERTYGET, VT_R4, (void*)&result, parms,
		hObject);
	return result;
}
...
unsigned long CLead::GetMagGlassMask(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x213, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		iIndex);
	return result;
}
...
BOOL CLead::AnnGetGrouping(long hObject)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x215, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms,
		hObject);
	return result;
}
...
{
	short result;
	InvokeHelper(0x219, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}

short CLead::UpdateMagGlass(const VARIANT& vColorBuffer, long lColorSize, long hMaskPlane, short iMaskPlaneStart, short iMaskPlaneEnd, BOOL bUpdateBitmap)
{
	short result;
	static BYTE parms[] =
		VTS_VARIANT VTS_I4 VTS_I4 VTS_I2 VTS_I2 VTS_BOOL;
	InvokeHelper(0x21b, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		&vColorBuffer, lColorSize, hMaskPlane, iMaskPlaneStart, iMaskPlaneEnd, bUpdateBitmap);
	return result;
}
...
BOOL CLead::IsTwainAvailable(long hWnd)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4;
...
short CLead::TwainAcquireFile(long hWnd, LPCTSTR pszName, long lFormat)
{
	short result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR VTS_I4;
	InvokeHelper(0x224, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		hWnd, pszName, lFormat);
	return result;
}
...
short CLead::Deskew2(unsigned long crBack)
{
	short result;
	static BYTE parms[] =
		VTS_I4;
...
short CLead::GetMaskTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x232, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		iIndex);
	return result;
}
...
short CLead::GetHTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x233, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		iIndex);
	return result;
}
...
short CLead::GetSTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x234, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		iIndex);
	return result;
}
...
short CLead::GetVTable(short iIndex)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x235, DISPATCH_PROPERTYGET, VT_I2, (void*)&result, parms,
		iIndex);
	return result;
}
...
short CLead::HSV_VfromRGB(unsigned long cr)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x238, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
		cr);
	return result;
}
...
{
	short result;
	InvokeHelper(0x23f, DISPATCH_METHOD, VT_I2, (void*)&result, NULL);
	return result;
}
...
long CLead::GetHistogramGrayTable(long nIndex)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x241, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, parms,
		nIndex);
	return result;
}
...
short CLead::UpdateMagGlassShape(short nMagGlassShape, long hMagGlassRgn)
{
	...
	static BYTE parms[] =
		VTS_I2 VTS_I4;
	InvokeHelper(0x243, DISPATCH_METHOD, VT_I2, (void*)&result, parms,
...
short CLead::UpdateMagGlassExt(const VARIANT& vColorBuffer, const VARIANT& vMaskPlane, long nMaskPlaneStart, long nMaskPlaneEnd, BOOL bUpdateBitmap)
{
	short result;
	static BYTE parms[] =
