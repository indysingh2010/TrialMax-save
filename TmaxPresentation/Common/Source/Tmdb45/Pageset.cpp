...
//
// Description:	This file contains member functions of the CPageSet class.
//
// See Also:	pageset.h
//
...
//	MAPS
//------------------------------------------------------------------------------
IMPLEMENT_DYNAMIC(CPageSet, CDaoRecordset)

//==============================================================================
//
// 	Function Name:	CPageSet::CPageSet()
//
// 	Description:	This is the constructor for CPageSet objects.
//
// 	Returns:		None
//
//	Notes:			None
//
//==============================================================================
CPageSet::CPageSet(CDaoDatabase* pDatabase) : CDaoRecordset(pDatabase)
{
	//{{AFX_FIELD_INIT(CPageSet)
	m_MediaID = _T("");
	m_PageID = 0;
	m_PlaybackOrder = 0;
	m_DisplayType = 0;
...
//==============================================================================
//
// 	Function Name:	CPageSet::DoFieldExchange()
//
...
//
//==============================================================================
void CPageSet::DoFieldExchange(CDaoFieldExchange* pFX)
{
	...
	DFX_Long(pFX, _T("[SlideID]"), m_SlideID);
	//}}AFX_FIELD_MAP
}

//==============================================================================
//
// 	Function Name:	CPageSet::FilterOnMedia()
//
...
//
//==============================================================================
BOOL CPageSet::FilterOnMedia(LPCSTR lpMediaId)
{
	//	Build the filter
...
//==============================================================================
//
// 	Function Name:	CPageSet::GetCount()
//
...
//==============================================================================
//
// 	Function Name:	CPageSet::GetDefaultDBName()
//
...
//
//==============================================================================
CString CPageSet::GetDefaultDBName()
{
	return _T("");
}
...
//==============================================================================
//
// 	Function Name:	CPageSet::GetDefaultSQL()
//
...
//
//==============================================================================
CString CPageSet::GetDefaultSQL()
{
	return _T("[Pages]");
}
