/*************************************************************
   Ltpnt.h - Digital paint runtime library
...
#if !defined(L_LTPNT_API)
   #define L_LTPNT_API
#endif // #if !defined(L_LTPNT_API)
...
#else
typedef PAINTTEXTA PAINTTEXT;
typedef pPAINTTEXTA pPAINTTEXT;
...
// general paint functions.
   ...
   L_LTPNT_API L_INT EXT_FUNCTION L_PntIsValid           ( pPAINTHANDLE pPaint ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntInit              ( ppPAINTHANDLE ppPaint ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntFree              ( pPAINTHANDLE pPaint ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetPropertyA      ( pPAINTHANDLE pPaint, PAINTGROUP nGroup, const L_VOID *pProperty ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntGetPropertyA      ( pPAINTHANDLE pPaint, PAINTGROUP nGroup, const L_VOID *pProperty ) ;
#if defined(FOR_UNICODE)
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetProperty       ( pPAINTHANDLE pPaint, PAINTGROUP nGroup, const L_VOID *pProperty ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntGetProperty       ( pPAINTHANDLE pPaint, PAINTGROUP nGroup, const L_VOID *pProperty ) ;
#else
#define L_PntSetProperty L_PntSetPropertyA
#define L_PntGetProperty L_PntGetPropertyA
#endif // #if defined(FOR_UNICODE)
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetMetrics        ( pPAINTHANDLE pPaint, HDC UserDC, pBITMAPHANDLE pBitmap, HPALETTE hRestrictionPalette ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetTransformation ( pPAINTHANDLE pPaint, pPAINTXFORM pXForm ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntGetTransformation ( pPAINTHANDLE pPaint, pPAINTXFORM pXForm ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetDCExtents      ( pPAINTHANDLE pPaint, const LPRECT prcRect ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntGetDCExtents      ( pPAINTHANDLE pPaint, LPRECT prcRect ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetClipRgn        ( pPAINTHANDLE pPaint, HRGN hClipRgn ) ;
   L_LTPNT_API L_INT EXT_FUNCTION L_PntGetClipRgn        ( pPAINTHANDLE pPaint, pHRGN phClipRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntOffsetClipRgn     ( pPAINTHANDLE pPaint, L_INT nDX, L_INT nDY ) ;
   
   // brush fucntions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntBrushMoveTo ( pPAINTHANDLE pPaint, HDC UserDC, L_INT nX, L_INT nY ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntBrushLineTo ( pPAINTHANDLE pPaint, HDC UserDC, L_INT nX, L_INT nY ) ; 
   
   // shape functions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapeLine       ( pPAINTHANDLE pPaint, HDC UserDC, L_INT nStartX, L_INT nStartY, L_INT nEndX, L_INT nEndY ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapeRectangle  ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapeRoundRect  ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapeEllipse    ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapePolygon    ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoints, L_INT nCount ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntDrawShapePolyBezier ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoints, L_INT nCount ) ; 
   
   // region functions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionRect      ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionRoundRect ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionEllipse   ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionPolygon   ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoints, L_INT nCount, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionSurface   ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoint, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionBorder    ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoint, const COLORREF crBorderColor, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionColor     ( pPAINTHANDLE pPaint, HDC UserDC, const COLORREF crColor, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionTranslate ( pPAINTHANDLE pPaint, L_INT dx, L_INT dy, pHRGN phDestRgn ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntRegionScale     ( pPAINTHANDLE pPaint, L_INT nHScaleFactor, L_INT nVScaleFactor, PAINTALIGNMENT nAlignment, pHRGN phDestRgn ) ; 
   
   // fill functions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntFillSurface      ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoint ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntFillBorder       ( pPAINTHANDLE pPaint, HDC UserDC, const LPPOINT pptPoint, const COLORREF crBorderColor ) ; 
   L_LTPNT_API L_INT EXT_FUNCTION L_PntFillColorReplace ( pPAINTHANDLE pPaint, HDC UserDC, const COLORREF crColor ) ; 
   
   // text functions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntApplyText ( pPAINTHANDLE pPaint, HDC UserDC, const LPRECT prcRect ) ; 
   
   // paint helping functions.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntPickColor ( pPAINTHANDLE pPaint, HDC UserDC, L_INT nX, L_INT nY, COLORREF* pcrDestColor ) ;
   
   //{ UNDOCUMENTED FUNCTIONS.
   L_LTPNT_API L_INT EXT_FUNCTION L_PntSetCallback ( pPAINTHANDLE pPaint, pPAINTCALLBACK pCallback, L_VOID *pUserData ) ;
   //} UNDOCUMENTED FUNCTIONS.

   L_LTPNT_API L_INT EXT_FUNCTION L_PntUpdateLeadDC ( pPAINTHANDLE pPaint, 
                                          pBITMAPHANDLE pBitmap ) ;

#undef L_HEADER_ENTRY
#include "ltpck.h"

#endif // #if !defined(LTPNT_H)
