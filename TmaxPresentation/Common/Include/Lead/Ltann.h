...
#if !defined(L_LTANN_API)
   #define L_LTANN_API
#endif // #if !defined(L_LTANN_API)
...
#define OPTIONS_NEW_ALL                0x0fff
#else // v15 or earlier
#define OPTIONS_NEW_ALL                0x07ff
#endif
...
L_VOID L_AnnDumpSmartDistanceA(ANNSMARTDISTANCE sdSmartDistance, L_CHAR *pszSmartDistance, L_UINT *puLength);
...
L_VOID L_AnnDumpSmartDistance(ANNSMARTDISTANCE sdSmartDistance, L_TCHAR *pszSmartDistance, L_UINT *puLength);
