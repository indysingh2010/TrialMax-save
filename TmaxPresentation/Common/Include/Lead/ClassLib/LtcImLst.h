...
class LWRP_EXPORT LImageListControl :public LBase
{
   ...
   public:
      ...
      L_INT GetBackColor(COLORREF * pcrBack);
      L_INT SetBackColor(COLORREF crBack);

      L_INT GetBorderColor(COLORREF * pcrBorder);
      ...
      L_INT ImportBitmapList(pLILIMPORTBITMAPLIST pImportList);
      L_INT ExportBitmapList(pLILEXPORTBITMAPLIST pExportList);
      L_INT SortExt(pLILSORTOPTIONS pSortOptions);
};
