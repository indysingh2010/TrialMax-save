...
class LWRP_EXPORT LBarCode : public LBase
{
   ...
   public:
      ...
      LBarCode(LBitmapBase * pLBitmap); /* Bar Code Class Constructor */
      ...
      L_VOID   SetBitmap(LBitmapBase * pLBitmap);
      ...
      L_INT    Write(pBARCODEDATA         pBarCodeData,
                     ...
                     pBARCODEWRITEQR      pBarCodeQR = NULL,
      ...
      static L_INT BarVersionInfo(pBARCODEVERSION   pBarCodeVersion, L_UINT uStructSize);
};
