...
class LWRP_EXPORT LAnnotationWindow : public LBitmapWindow
{
   ...
   private:
      L_VOID            OnAnnotationEvent(L_UINT uAnnEvent,LPARAM lParam);
   ...
   protected:
      ...
      virtual L_VOID    OnAnnEvent(L_UINT uAnnEvent,LPARAM lParam);
   ...
   public : 
      ...
      virtual L_INT     AnnLoad(L_TCHAR * pszFile,pLOADFILEOPTION pLoadFileOption=NULL);
      virtual L_INT     AnnLoadMemory(L_UCHAR  *phGlobalAnn, L_UINT32 uMemSize);

      virtual L_INT     AnnSave(L_TCHAR * pszFile, L_INT nFormat=ANNFMT_XML,L_BOOL bSelected=FALSE);
