...
class LWRP_EXPORT LToolbar: public LBase
{
   ...
   private:
      static L_INT EXT_CALLBACK ToolbarCS(pTOOLBARHANDLE  pToolbar, L_UINT nButtonID, L_UINT32 dwData, L_VOID *pUserData);
   ...
   public:
      ...
      L_BOOL            IsValid();
      L_INT             Initialize(); 
      L_INT             Create(HWND hwndParent, L_TCHAR * pszTitle, L_UINT32 dwFlags);
      ...
      L_INT             GetToolbarInfo(pLTOOLBARINFO pToolbarInfo, L_UINT uStructSize);
      ...
      L_INT             GetButtonInfo(L_UINT uButtonId, pLBUTTONINFO pButtonInfo, L_UINT uStructSize);
