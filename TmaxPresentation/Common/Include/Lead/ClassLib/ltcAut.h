...
class LWRP_EXPORT LAutomation: public LBase
{
   ...
   private:
      static L_INT   EXT_CALLBACK  EnumContainersCS(pCONTAINERHANDLE pContainer, L_VOID *pUserData);
   ...
   public:
      ...
      L_INT                AddContainer(LContainer * pLContainer, L_VOID *pModeData);
      L_INT                EnumContainers();
      L_INT                SetPaintProperty(PAINTGROUP nGroup, const L_VOID *pProperty);
      L_INT                GetPaintProperty(PAINTGROUP nGroup, L_VOID *pProperty);
      ...
      L_INT                EditVectorObject(LVectorObject *pEditObject);
