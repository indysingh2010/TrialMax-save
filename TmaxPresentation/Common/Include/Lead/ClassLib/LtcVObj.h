...
} VECTOROBJECTUNION, *pVECTOROBJECTUNION;
...
protected:
   LVectorBase		   *m_pLVector;        //vector object belongs to
...
public : 
   ...
   L_INT GetObjectRect(RECT *pRect);
   
   L_INT IsObjectInsideParallelogram(const pVECTORPOINT pLeftTop, const pVECTORPOINT pRightBottom, L_BOOL *bInside);
   L_INT IsObjectInsideRect(const RECT *pRect, L_BOOL *bInside);
   
   L_INT SelectObject(L_BOOL bSelect=TRUE);
   L_INT IsObjectSelected(L_BOOL *pbSelected);

   L_INT HideObject(L_BOOL bHide=TRUE);
   L_INT IsObjectHidden(L_BOOL *pbHidden);
   ...
   L_INT SetTooltip( L_TCHAR *pszTooltip );
   L_UINT32 GetTooltip( L_TCHAR *pBuffer, L_UINT32 uSize );
   ...
   L_INT SetDescription( L_TCHAR *pszTarget );
   L_UINT32 GetDescription( L_TCHAR *pBuffer, L_UINT32 uSize );
};
...
//************ LVectorSpline ************************************************************
class LWRP_EXPORT LVectorSpline : public LVectorObject
{
   LEAD_DECLAREOBJECT(LVectorSpline); 
   
public : 
   LVectorSpline(pVECTORSPLINE pSpline = NULL); 
   LVectorSpline(pVECTOROBJECT pObject,  LVectorBase *pVector=NULL);
   ~LVectorSpline();   
   virtual L_INT  LockObject(pVECTORSPLINE pSpline);   
   virtual L_INT  UnlockObject(pVECTORSPLINE pSpline);
};

//************ LVectorHPolyBezier ************************************************************
class LWRP_EXPORT LVectorHPolyBezier : public LVectorObject
{
   LEAD_DECLAREOBJECT(LVectorHPolyBezier); 
   
public : 
   LVectorHPolyBezier(pVECTORHPOLYBEZIER pPolyLine = NULL); 
   LVectorHPolyBezier(pVECTOROBJECT pObject,  LVectorBase *pVector=NULL);
   ~LVectorHPolyBezier();   
   virtual L_INT  LockObject(pVECTORHPOLYBEZIER pPolyLine);   
   virtual L_INT  UnlockObject(pVECTORHPOLYBEZIER pPolyLine);
};
