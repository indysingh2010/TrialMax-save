...
} CAPADPCMWAVEFORMAT, *LPCAPADPCMWAVEFORMAT;
...
typedef struct capdvi_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16            wSamplesPerBlock;
} CAPDVIADPCMWAVEFORMAT,  *LPCAPDVIADPCMWAVEFORMAT;
...
typedef struct capima_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wSamplesPerBlock;
} CAPIMAADPCMWAVEFORMAT,  *LPCAPIMAADPCMWAVEFORMAT;
...
typedef struct capmediaspace_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPMEDIASPACEADPCMWAVEFORMAT,     *LPCAPMEDIASPACEADPCMWAVEFORMAT;
...
typedef struct capsierra_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPSIERRAADPCMWAVEFORMAT, *LPCAPSIERRAADPCMWAVEFORMAT;
...
} CAPG723_ADPCMWAVEFORMAT, *LPCAPG723_ADPCMWAVEFORMAT;
...
typedef struct capdigistdwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAP_DIGISTDWAVEFORMAT, *LPCAPDIGISTDWAVEFORMAT;
...
typedef struct capdigifixwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPDIGIFIXWAVEFORMAT, *LPCAPDIGIFIXWAVEFORMAT;
...
typedef struct capcreative_fastspeechformat_tag{
        WAVEFORMATDATA  ewf;
}CAPDIALOGICOKIADPCMWAVEFORMAT, *LPCAPDIALOGICOKIADPCMWAVEFORMAT;
...
} CAPYAMAHA_ADPCMWAVEFORMAT, *LPCAPYAMAHA_ADPCMWAVEFORMAT;
...
typedef struct capsonarcwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wCompType;
} CAPSONARCWAVEFORMAT, *LPCAPSONARCWAVEFORMAT;
...
} CAPTRUESPEECHWAVEFORMAT, *LPCAPTRUESPEECHWAVEFORMAT;
...
typedef struct capechosc1waveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPECHOSC1WAVEFORMAT, *LPCAPECHOSC1WAVEFORMAT;
...
typedef struct capaudiofile_af36waveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPAUDIOFILE_AF36WAVEFORMAT, *LPCAPAUDIOFILE_AF36WAVEFORMAT;
...
typedef struct capaptxwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPAPTXWAVEFORMAT, *LPCAPAPTXWAVEFORMAT;
...
typedef struct capaudiofile_af10waveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPAUDIOFILE_AF10WAVEFORMAT, *LPCAPAUDIOFILE_AF10WAVEFORMAT;
...
typedef struct capdolbyac2waveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT        nAuxBitsCode;
} CAPDOLBYAC2WAVEFORMAT, *LPCAPDOLBYAC2WAVEFORMAT;
...
WAVEFORMATDATA  wfx;
L_UINT16        wSamplesPerBlock;
} CAPGSM610WAVEFORMAT, *LPCAPGSM610WAVEFORMAT;
...
typedef struct capadpcmewaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wSamplesPerBlock;
} CAPADPCMEWAVEFORMAT, *LPCAPADPCMEWAVEFORMAT;
...
typedef struct capcontres_vqlpcwaveformat_tag {
         WAVEFORMATDATA    wfx;
         L_UINT16          wSamplesPerBlock;
} CAPCONTRESVQLPCWAVEFORMAT, *LPCAPCONTRESVQLPCWAVEFORMAT;
...
typedef struct capdigirealwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wSamplesPerBlock;
} CAPDIGIREALWAVEFORMAT, *LPCAPDIGIREALWAVEFORMAT;
...
typedef struct capdigiadpcmmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wSamplesPerBlock;
} CAPDIGIADPCMWAVEFORMAT, *LPCAPDIGIADPCMWAVEFORMAT;
...
typedef struct capcontres_cr10waveformat_tag {
      WAVEFORMATDATA  wfx;
      L_UINT16        wSamplesPerBlock;
} CAPCONTRESCR10WAVEFORMAT, *LPCAPCONTRESCR10WAVEFORMAT;
...
typedef struct capnms_vbxadpcmmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wSamplesPerBlock;
} CAPNMS_VBXADPCMWAVEFORMAT, *LPCAPNMS_VBXADPCMWAVEFORMAT;
...
typedef struct capg721_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        nAuxBlockSize;
} CAPG721_ADPCMWAVEFORMAT, *LPCAPG721_ADPCMWAVEFORMAT;
...
typedef struct capmpeg1waveformat_tag {
    ...
    L_UINT32        dwPTSLow;
    L_UINT32        dwPTSHigh;
} CAPMPEG1WAVEFORMAT, *LPCAPMPEG1WAVEFORMAT;
...
typedef struct capcreative_adpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPCREATIVEADPCMWAVEFORMAT, *LPCAPCREATIVEADPCMWAVEFORMAT;
...
typedef struct capcreative_fastspeech8format_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPCREATIVEFASTSPEECH8WAVEFORMAT, *LPCAPCREATIVEFASTSPEECH8WAVEFORMAT;
...
typedef struct capcreative_fastspeech10format_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPCREATIVEFASTSPEECH10WAVEFORMAT, *LPCAPCREATIVEFASTSPEECH10WAVEFORMAT;
...
typedef struct capfmtowns_snd_waveformat_tag {
        WAVEFORMATDATA  wfx;
        L_UINT16        wRevision;
} CAPFMTOWNS_SND_WAVEFORMAT, *LPCAPFMTOWNS_SND_WAVEFORMAT;
...
typedef struct capoligsmwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPOLIGSMWAVEFORMAT, *LPCAPOLIGSMWAVEFORMAT;
...
typedef struct capoliadpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPOLIADPCMWAVEFORMAT, *LPCAPOLIADPCMWAVEFORMAT;
...
typedef struct capolicelpwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPOLICELPWAVEFORMAT, *LPCAPOLICELPWAVEFORMAT;
...
typedef struct capolisbcwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPOLISBCWAVEFORMAT, *LPCAPOLISBCWAVEFORMAT;
...
typedef struct capolioprwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPOLIOPRWAVEFORMAT, *LPCAPOLIOPRWAVEFORMAT;
...
typedef struct capcsimaadpcmwaveformat_tag {
        WAVEFORMATDATA  wfx;
} CAPCSIMAADPCMWAVEFORMAT, *LPCAPCSIMAADPCMWAVEFORMAT;
