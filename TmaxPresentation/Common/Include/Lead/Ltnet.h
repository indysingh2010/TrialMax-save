...
#if !defined (_LTNET_H_)
#define _LTNET_H_

#if !defined(L_LTNET_API)
   #define L_LTNET_API
#endif // #if !defined(L_LTNET_API)
...
typedef struct waveData {
    L_CHAR * lpData;                 /* pointer to locked data buffer */
    ...
    struct waveData *lpNext;     /* reserved for driver */
...
L_LTNET_API L_INT EXT_FUNCTION L_InetConnect(L_CHAR *pszAddress,
                                 L_INT nPort,
                                 L_COMP *phComputer,
                                 INETCALLBACK pfnCallback,
                                 L_VOID *pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetServerInit(L_INT nPort,
                                    L_COMP *phComputer,
                                    INETCALLBACK pfnCallback,
                                    L_VOID *pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetClose(L_COMP hComputer, L_BOOL bGraceful);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendData(L_COMP hComputer, 
                                  L_CHAR *pBuffer, 
                                  L_SIZE_T *pulBufferLength,
                                  IDATATYPE uDataType);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendMMData(L_COMP hComputer, 
                                    L_CHAR *pBuffer, 
                                    L_SIZE_T *pulBufferLength);

L_LTNET_API L_INT EXT_FUNCTION L_InetReadData(L_COMP hComputer, 
                                  L_CHAR *pBuffer, 
                                  L_UINT32 *pulBufferLength);


L_LTNET_API L_INT EXT_FUNCTION L_InetGetHostName(L_COMP hHost,
                                     L_CHAR *pszName,
                                     L_INT nType,
                                     L_SIZE_T *pulBufferLength);

L_LTNET_API L_INT EXT_FUNCTION L_InetAcceptConnect(L_COMP hHost, 
                                       L_COMP *phRemote,
                                       INETCALLBACK pfnCallback,
                                       L_VOID *pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendBitmap(L_COMP hComputer, 
...
L_LTNET_API L_INT EXT_FUNCTION L_InetAutoProcess(L_COMP hComputer,
                                     L_BOOL bProcess);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendRawData(L_COMP hComputer, 
                                     L_CHAR *pBuffer,
                                     L_SIZE_T *pulBufferLength);

L_LTNET_API L_INT EXT_FUNCTION L_InetGetQueueSize(L_COMP hComputer, 
                                      L_SIZE_T *pulLength);

L_LTNET_API L_INT EXT_FUNCTION L_InetClearQueue(L_COMP hComputer);

L_LTNET_API L_INT EXT_FUNCTION L_InetStartUp(void);

L_LTNET_API L_INT EXT_FUNCTION L_InetShutDown(void);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendSound(L_COMP hComputer, 
                                   LPWAVEFORMATDATA pWaveFormatData, 
                                   LPWAVEDATA pWaveData, 
                                   L_SIZE_T *pdwDataSize);

L_LTNET_API L_INT EXT_FUNCTION L_InetAttachToSocket(L_COMP *phComputer,
                                       SOCKET hSocket,
                                       INETCALLBACK pfnCallback,
                                       L_VOID *pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetDetachFromSocket(L_COMP hComputer,
                                          L_BOOL bWaitTillQueueEmpty,
                                          SOCKET *phSocket);

L_LTNET_API L_INT EXT_FUNCTION L_InetSetCallback(L_COMP hComputer,
                                     INETCALLBACK  pfnCallback,
                                     L_VOID * pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetGetCallback(L_COMP hComputer,
                                     INETCALLBACK *ppfnCallback,
                                     L_VOID ** ppUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetCreatePacket(pHINETPACK phPacket,
                                       L_UINT uExtra,
                                       L_VOID *pExtra,
                                       L_CHAR *pszFormat,
                                       ...);

L_LTNET_API L_INT EXT_FUNCTION L_InetCreatePacketFromParams(pHINETPACK phPacket,
                                       L_UINT uExtra,
                                       L_VOID *pExtra,
                                       L_UINT uParams,
                                       pPARAMETER pParams);

L_LTNET_API L_VOID EXT_FUNCTION L_InetFreePacket(HINETPACK hPacket);


L_LTNET_API L_INT EXT_FUNCTION L_InetSendCmd(L_COMP hComputer, 
                                 CMDTYPE uCommand,
                                 L_UINT uCommandID,
                                 HINETPACK hPacket);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendRsp(L_COMP hComputer, 
                                 CMDTYPE uCommand,
                                 L_UINT uCommandID,
                                 HINETPACK hPacket,
                                 L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendLoadCmdA(L_COMP hComputer,
                                     L_UINT uCommandID,
                                     L_CHAR *pszFile,
                                     L_INT nBitsPerPixel,
                                     L_INT nOrder,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendLoadCmd(L_COMP hComputer,
                                     L_UINT uCommandID,
                                     L_TCHAR *pszFile,
                                     L_INT nBitsPerPixel,
                                     L_INT nOrder,
                                     L_UINT uFlags);
#else
#define L_InetSendLoadCmd L_InetSendLoadCmdA
#endif // #if defined(FOR_UNICODE)

L_LTNET_API L_INT EXT_FUNCTION L_InetSendLoadRsp(L_COMP hComputer,
                                     L_UINT uCommandID,
                                     L_UINT uBitmapID,
                                     L_UINT uExtra,
                                     L_CHAR *pExtra,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendSaveCmdA(L_COMP hComputer,
                                     L_UINT uCommandID,
                                     L_CHAR *pszFile,
                                     L_UINT uBitmapID,
                                     L_INT nFormat,
                                     ...
                                     L_UINT uFlags);
#if defined(FOR_UNICODE)
L_LTNET_API L_INT EXT_FUNCTION L_InetSendSaveCmd(L_COMP hComputer,
                                     L_UINT uCommandID,
                                     L_TCHAR *pszFile,
                                     L_UINT uBitmapID,
                                     L_INT nFormat,
                                     ...
                                     L_UINT uFlags);
#else
#define L_InetSendSaveCmd L_InetSendSaveCmdA
#endif // #if defined(FOR_UNICODE)

L_LTNET_API L_INT EXT_FUNCTION L_InetSendSaveRsp(L_COMP hComputer,
                                      L_UINT uCommandID,
                                      L_UINT uExtra,
                                      L_CHAR *pExtra,
                                      L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendCreateWinCmdA(L_COMP hComputer,
                                          L_UINT uCommandID,
                                          L_CHAR *pszClassName,
                                          L_CHAR *pszWindowName,
                                          L_UINT ulFlags,
                                          L_INT nLeft,
                                          L_INT nTop,
                                          L_INT nWidth, 
                                          ...
                                          L_UINT uParentID);
#if defined(FOR_UNICODE)
L_LTNET_API L_INT EXT_FUNCTION L_InetSendCreateWinCmd(L_COMP hComputer,
                                          L_UINT uCommandID,
                                          ...
                                          L_UINT uParentID);
#else
#define L_InetSendCreateWinCmd L_InetSendCreateWinCmdA
#endif // #if defined(FOR_UNICODE)

L_LTNET_API L_INT EXT_FUNCTION L_InetSendCreateWinRsp(L_COMP hComputer,
                                          L_UINT uCommandID,
                                          LONG_PTR uWindowID,
                                          L_UINT uLength,
                                          L_CHAR *pExtraInfo,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendSizeWinCmd(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        LONG_PTR uWindowID,
                                        L_INT nLeft,
                                        L_INT nTop,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendSizeWinRsp(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        L_UINT uLength,
                                        L_CHAR *pExtraInfo,
                                        L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendShowWinCmd(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        LONG_PTR uWindowID,
                                        L_INT nCmdShow);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendShowWinRsp(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        L_UINT uLength,
                                        L_CHAR *pExtraInfo,
                                        L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendCloseWinCmd(L_COMP hComputer,
                                         L_UINT uCommandID,
                                         LONG_PTR uWindowID);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendCloseWinRsp(L_COMP hComputer,
                                         L_UINT uCommandID,
                                         L_UINT uLength,
                                         L_CHAR *pExtraInfo,
                                         L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendFreeBitmapCmd(L_COMP hComputer,
                                         L_UINT uCommandID,
                                         L_UINT uBitmapID);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendFreeBitmapRsp(L_COMP hComputer,
                                         L_UINT uCommandID,
                                         L_UINT uLength,
                                         L_CHAR *pExtraInfo,
                                         L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendSetRectCmd(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        LONG_PTR uWindowID,
                                        RECTTYPE nType,
                                        L_INT nLeft,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendSetRectRsp(L_COMP hComputer,
                                        L_UINT uCommandID,
                                        L_UINT uLength,
                                        L_CHAR *pExtraInfo,
                                        L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSetCommandCallback(L_COMP hComputer, 
                                            INETCOMMANDCALLBACK pfnCallback,
                                            L_VOID *pUserData);

L_LTNET_API L_INT EXT_FUNCTION L_InetSetResponseCallback(L_COMP hComputer,
                                             INETRESPONSECALLBACK pfnCallback,
                                             L_VOID *pUserData);


L_LTNET_API L_INT EXT_FUNCTION L_InetSendAttachBitmapCmd(L_COMP hComputer,
                                             L_UINT uCommandID,
                                             L_UINT uBitmapID,
                                             LONG_PTR uWindowID);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendAttachBitmapRsp(L_COMP hComputer,
                                             L_UINT uCommandID,
                                             L_UINT uExtra,
                                             L_CHAR *pExtra,
                                             L_INT nStatus);

L_LTNET_API L_INT EXT_FUNCTION L_InetSendGetMagGlassDataCmd(L_COMP hComputer,
                                                L_UINT uCommandID,
                                                L_UINT uBitmapID,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetSendGetMagGlassDataRsp(L_COMP hComputer,
                                                L_UINT uCommandID,
                                                L_UINT32 lColorSize,
                                                COLORREF *pColor,
...
L_LTNET_API L_INT EXT_FUNCTION L_InetGetMagGlassData(pBITMAPHANDLE pBitmap,
