...
/*	TRIALMAX MODIFICATION */
#if defined NOT_TRIALMAX
...
#define ERROR_PANWINDOW_NOT_CREATED     -91  /** PanWindow was not created **/
#define ERROR_NOT_ENOUGH_IMAGES         -92  /** Not enough images   **/
...
#define ERROR_FPX_FILE_CREATE_ERROR          -131  /* Error creating filr */
#define ERROR_FPX_FILE_NOT_OPEN_ERROR        -132  /* File not open */
#define ERROR_FPX_USER_ABORT                 -133  /* User abort */
#define ERROR_FPX_OLE_FILE_ERROR             -134  /* OLE file error */
...
#define ERROR_LZW_LOCKED                     -146  /* LZW is locked */
#define ERROR_FPXEXTENSIONS_LOCKED           -147  /* FPX Extensions is locked */
#define ERROR_ANN_LOCKED                     -148  /* the annotation object is locked */
...
#define ERROR_ISIS_NOCURSCANNER              -160  /* No ISIS Scanner selected */
...
#define ERROR_ISIS_BAD_TAG_OR_VALUE          -163  /* Bad ISIS Tag or Bad Tag Value */
#define ERROR_ISIS_NOT_READY                 -164  /* ISIS Scanner not ready */
#define ERROR_ISIS_NO_PAGE                   -165  /* No page in the ISIS Scanner */
...
#define ERROR_ISIS_NOT_INSTALLED             -171  /* ISIS is not installed */
#define ERROR_ISIS_NO_PIXDFLT                -172  /* ISIS is not installed */
#define ERROR_ISIS_PIXVERSION                -173  /* ISIS version is incorrect */
#define ERROR_ISIS_PERM_NOACCESS             -174  /* No permission/access */
...
#define ERROR_INSUFICIENT_BUFFER             -290  /* The buffer size is too small */
...
#define ERROR_INVALID_DELAY                     -321  /* the user passed an invalid delay value */
#define ERROR_INVALID_COUNT                     -322  /* the user passed an invalid capture count */
#define ERROR_INVALID_INTERVAL                  -323  /* the user passed an invalid interval value */
#define ERROR_HOTKEY_CONFLICTS_WITH_CANCELKEY   -324  /* the user specified the hotkey to be the same as the cancel key */
#define ERROR_CAPTURE_INVALID_AREA_TYPE         -325  /* wrong area type passed to L_CaptureArea() */
#define ERROR_CAPTURE_NO_OPTION_STRUCTURE       -326  /* invalid options structure pointer */
...
#define ERROR_CAPTURE_ZERO_AREA_SIZE            -331  /* Capture area is zero */
#define ERROR_CAPTURE_FILE_ACCESS_FAILED        -332  /* The specified filename couldn't be read */
...
#define ERROR_CAPTURE_STRING_ID_NOT_DEFINED     -338  /* ID string is undefined. */
#define ERROR_CAPTURE_DELAY_LESS_THAN_ZERO      -339  /* Delay value must be at least zero. */
#define ERROR_CAPTURE_NO_MENU                   -340  /* No menu to capture. */

#define ERROR_BROWSE_FAILED                     -350  /* directory browsing failed */
#define ERROR_NOTHING_TO_DO                     -351  /* There is nothing to do! */
...
#define ERROR_PDF_FILE_ENCRYPTED                -721  /* The Pdf file is encrypted and the szPassword 
                                                         ...
                                                         (no password).*/
#define ERROR_PDF_INVALID_PASSWORD              -722  
#define ERROR_PDF_FAX_NOT_ENABLED               -723  /* This feature requires Fax engine . */
#define ERROR_PDF_JPEG_NOT_ENABLED              -724  /* This feature requires Jpeg engine . */
