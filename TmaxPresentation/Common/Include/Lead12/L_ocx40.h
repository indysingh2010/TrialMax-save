...
{ \
   ...
   (leadocx).UnlockSupport(L_SUPPORT_MULTIMEDIA         ,L_KEY_MULTIMEDIA         ); \
   (leadocx).UnlockSupport(L_SUPPORT_MEDICAL            ,L_KEY_MEDICAL            ); \
   (leadocx).UnlockSupport(L_SUPPORT_JBIG               ,L_KEY_MEDICAL_NET        ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR             ,L_KEY_JBIG               ); \
   (leadocx).UnlockSupport(L_SUPPORT_MEDICAL_NET        ,L_KEY_VECTOR             ); \
   ...
   (leadocx).UnlockSupport(L_SUPPORT_INTERNET           ,L_KEY_INTERNET           ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_DWG         ,L_KEY_VECTOR_DWG         ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_DXF         ,L_KEY_VECTOR_DXF         ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_MISC        ,L_KEY_VECTOR_MISC        ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_ALL         ,L_KEY_VECTOR_ALL         ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_DWF         ,L_KEY_VECTOR_DWF         ); \
   (leadocx).UnlockSupport(L_SUPPORT_RESERVED1          ,L_KEY_RESERVED1          ); \
   (leadocx).UnlockSupport(L_SUPPORT_PDF                ,L_KEY_PDF                ); \
   (leadocx).UnlockSupport(L_SUPPORT_VECTOR_VIEW        ,L_KEY_VECTOR_VIEW        ); \
   (leadocx).UnlockSupport(L_SUPPORT_DIGITALPAINT       ,L_KEY_DIGITALPAINT       ); \
}
...
#include "L_OcxErr.h"
   ...
   enum     AnnToolConstants {
      ...
      ANNTOOL_STAMP_FIRST = ANNTOOL_STAMP_APPROVED,
      ...
      ANNTOOL_STAMP_VOID,
      ANNTOOL_STAMP_LAST = ANNTOOL_STAMP_VOID,
...
END TRIALMAX MODIFICATION */
   ...
   enum CommentConstants {
       ...
       CMNT_SUPPORTEDFLASHPIXVERSION = 158,
       CMNT_COLORSPACE = 159,
       CMNT_EXPOSUREPROGRAM = 160,
       CMNT_SZSPECTRALSENSITIVITY = 161,
       CMNT_ISOSPEEDRATINGS = 162,
       CMNT_OPTOELECTRICCOEFFICIENT = 163,
       CMNT_SZRELATEDSOUNDFILE = 164,
       CMNT_FLASHENERGY = 165,
       CMNT_SPATIALFREQUENCYRESPONSE = 166,
       CMNT_FOCALPLANEXRESOLUTION = 167,
       CMNT_FOCALPLANEYRESOLUTION = 168,
       CMNT_SUBJECTLOCATION = 169,
       CMNT_EXPOSUREINDEX = 170,
       CMNT_SENSINGMETHOD = 171,
       CMNT_FILESOURCE = 172,
       CMNT_SCENETYPE = 173,
       CMNT_CFAPATTERN = 174,
       CMNT_SZTITLE = 175,
       CMNT_SZDISCLAIMER = 176,
       CMNT_SZWARNING = 177,
       CMNT_MISC = 178,
       CMNT_LAST = 178,
   };
...
#ifndef MAGGLASSMASK_CONSTANTS
#define MAGGLASSMASK_CONSTANTS
   typedef enum {
      MAGGLASS_MASK_NORMAL = 0x0000,
      MAGGLASS_MASK_INVERT = 0x0001,
   } MagGlassMaskConstants;
#endif
...
#define DOCCLEAN_CONSTANTS
      ...
      typedef enum {
         TWAIN_FORMAT_ABORT = -1,
         TWAIN_FORMAT_CONTINUE = 1,
         TWAIN_FORMAT_SET = 2,
      } TwainFileFormatStatusConstants;
