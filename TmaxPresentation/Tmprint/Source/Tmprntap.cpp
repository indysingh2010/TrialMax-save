//==============================================================================
//
// File Name:	tmprntap.cpp
//
// Description:	This file contains member functions of the CTMPrintApp class.
//
// See Also:	tmprntap.h
//
...
//	02-04-01	5.00		Added TreatmentImage parameter descriptor
//==============================================================================
...
//				Added SetPrintTemplates() method
//				Added SetPrintTemplate() method
//				Added GetPrintTemplates() method
//				Added GetPrintTemplate() method
//				Added SelectPrinter() method
//				Added IsReady() method
//				Added ShowStatus property
//				Added StartJob event
//				Added EndJob event
//				Added PrintPage event
//				Added PrintImage event
//				Added GetRegisteredPath() method
//				Added GetClassIdString() method
//				Added GetRowsPerPage() method
//				Added GetColumnsPerPage() method
//				Added Abort() method
//				Added LeftMargin property
//				Added TopMargin property
//				Added PrintCallouts property
//				Added PrintCalloutBorders property
//				Added CalloutBorderThickness property
//				Added CalloutBorderColor property
//
...
//	GLOBALS
//------------------------------------------------------------------------------
CTMPrintApp NEAR theApp;

/* Replace 1 */
const GUID CDECL BASED_CODE _tlid =
		{ 0x773bee87, 0x4362, 0x4bd9, { 0x97, 0xce, 0xbb, 0x76, 0xe4, 0xcd, 0xe8, 0xb3 } };
...
//==============================================================================
//
// 	Function Name:	CTMPrintApp::ExitInstance()
//
...
//==============================================================================
//
// 	Function Name:	CTMPrintApp::InitInstance()
//
