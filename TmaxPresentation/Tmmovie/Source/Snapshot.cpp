...
//
// Functions:   CSnapshot::Create()
//				CSnapshot::CreatePopup()
//				CSnapshot::CSnapshot()
//				CSnapshot::~CSnapshot()
//				CSnapshot::DrawDDBitmap()
//				CSnapshot::DrawDIBitmap()
//				CSnapshot::FreeDDBitmap()
//				CSnapshot::FreeDIBitmap()
//				CSnapshot::OnPaint()
//				CSnapshot::SetDDBitmap()
//				CSnapshot::SetDIBitmap()
//
// See Also:	snapshot.h
//
...
//
//==============================================================================
BOOL CSnapshot::Create(CTMMovieCtrl* pParent, BOOL bPopup) 
{
	RECT Rect;
